...
const CheckboxInputEdit = ({ index, permissions, inputProps, setFieldValue }: CheckboxInputEditProps) => {
    ...
    return (
        <div className="flex flex-wrap items-stretch my-3 p-5 pt-3 rounded-xl bg-slate-300">
            <p className="mb-3 text-sm font-medium">Checkbox Input</p>
...
export default CheckboxInputEdit;